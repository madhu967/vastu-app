  ...
  Telugu: {
    ...
    "plot-shapes": {
      ...
      paragraphs: [
        ...
        "చతురస్రం, దీర్ఘ చతురస్రం, వృత్తాకార స్థలాలను సకల గృహ, భవన నిర్మాణముల కొరకు ఎన్నుకొనవలయును."
      ],
      multiColumnTables: [
        {
    ...
    "shanku-sthapana": {
      ...
      bottomContent: [
        { heading: "", text: "శాస్త్ర ప్రకారం తయారు చేయబడిన శంకువుల కొరకు మమ్మల్ని సంప్రదించండి." }
      ]
    },
    "soil-testing": {
      title: "భూ పరీక్ష",
    ...
    "staircase": {
      ...
      paragraphs: [
        "నిర్మాణముల యందు పై అంతస్తు లోనికి వెళ్ళుటకు సోపానములు (Stair case) ఏర్పాటు తప్పనిసరి. ఆ సోపానములు ఎక్కుచూ వెళ్ళునట్లు ప్రదక్షిణ క్రమముగా పైకి వెళ్ళుట శ్రేయోదాయకము.",
